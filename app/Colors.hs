...
color_maps = M.fromList $ [
  ...
  -- experimental
  (12, rainbow 12  7 12 0),
  (19, rainbow 19 11 19 0),
  ...
  (34, rainbow 34  5 34 0), -- 7\34 = (4:3) ^ (1/2) = 247c
                            -- 5\34 = (3:2) ^ (1/4) = 176c
  (36, rainbow 36  7 36 0), -- 7\36 = (3:2) ^ (1/3) = 233c
  (41, rainbow 41  8 41 0), -- 12\41 = (3:2) ^ (1/2)
                            -- 8\41 = (3:2) ^ (1/3)
  (43, rainbow 43  5 43 0), -- 9\43 = (4:3) ^ (1/2), but I prefer
                            -- 5\43 = (3:2) ^ (1/5).
  (46, rainbow 46 27 46 0), -- 9\27 = 8:7 = (3:2)^(1/3)
  (48, rainbow 48 14 24 0), -- 14\48 = 350 cents
